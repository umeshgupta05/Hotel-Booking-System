  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          const roomsData = await api.getRoomsByHotel(id);
          setRooms(roomsData);
        } catch (roomErr) {
        ...
        console.error("Failed to load hotel:", hotelErr);
        setHotel(null);
        setError(hotelErr?.message || "Failed to load hotel details");
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="h-[400px] bg-slate-800 relative">
        <img
          ...
          onError={(e) => {
            ...
            e.target.src = "https://placehold.co/1600x900?text=Hotel+Image";
          }}
        />
