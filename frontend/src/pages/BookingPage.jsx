    ...
    <div className="min-h-screen py-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-slate-600 mb-8">
          Complete payment in 5 minutes to secure this room.
        </p>

        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1 surface-panel p-8">
            ...
            <form onSubmit={handleConfirm} className="space-y-6">
              ...
              <div className="pt-6 border-t border-slate-100">
                ...
                <div className="space-y-3">
                  <label className="flex items-center p-4 border border-blue-300 bg-blue-50/70 rounded-xl cursor-pointer transition-all hover:shadow-md">
                    <input
                      type="radio"
                  ...
                  <label className="flex items-center p-4 border border-slate-200 bg-slate-50/80 rounded-xl cursor-pointer transition-all hover:shadow-md">
                    <input
                      type="radio"
              ...
              <button
                type="submit"
                disabled={processing}
                className="w-full py-4 btn-primary disabled:opacity-70"
              >
                {processing
                  ? "Processing..."
                  : paymentMethod === "RAZORPAY"
